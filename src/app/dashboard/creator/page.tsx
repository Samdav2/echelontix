...
const StatCard = ({ title, value, icon, colorClass, trend }: { title: string; value: string; icon: React.ReactNode; colorClass: string, trend?: string }) => (
  <motion.div
    ...
    className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 flex flex-col justify-between shadow-2xl hover:border-white/20 transition-all duration-300 group"
  >
    <div className="flex justify-between items-center">
      <p className="font-medium text-gray-400 group-hover:text-white transition-colors uppercase tracking-wider text-xs">{title}</p>
    ...
    <div>
      ...
      {trend && (
        <div className="flex items-center gap-1 mt-2">
          <span className={`text-xs font-semibold px-2 py-0.5 rounded-full bg-white/5 border border-white/10 ${colorClass}`}>{trend}</span>
        </div>
      )}
    </div>
  </motion.div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black text-white p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-blue-600/20 rounded-full blur-[80px]" />
            <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-64 h-64 bg-purple-600/20 rounded-full blur-[80px]" />

            <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-8 text-center sm:text-left">
              <div>
                ...
                <p className="text-gray-400 mt-2 text-lg font-medium">
                  Welcome back, <span className="text-blue-400">{creatorData.name}</span>!
                </p>
              </div>
              <div className="flex flex-wrap items-center justify-center lg:justify-end gap-3 sm:gap-4">
                <button
                  onClick={handleCreateEventClick}
                  className="group flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white px-8 py-4 rounded-2xl font-bold border border-blue-400/50 shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] transition-all hover:-translate-y-1 w-full sm:w-auto"
                >
                ...
                <button
                  ...
                  className="group flex items-center justify-center gap-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white px-8 py-4 rounded-2xl font-bold border border-amber-400/50 shadow-[0_0_20px_rgba(245,158,11,0.3)] hover:shadow-[0_0_30px_rgba(245,158,11,0.5)] transition-all hover:-translate-y-1 w-full sm:w-auto"
                >
                ...
                <button
                  ...
                  className="group flex items-center justify-center gap-3 bg-white/5 border border-white/10 text-white px-8 py-4 rounded-2xl font-bold hover:bg-white/10 hover:border-white/20 transition-all shadow-xl hover:-translate-y-1 w-full sm:w-auto"
                >
                  <UserCog className="w-5 h-5 text-blue-400 group-hover:scale-110 transition-transform" />
