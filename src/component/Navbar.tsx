...
const Navbar = () => {
  return (
    ...
    <nav className="bg-gradient-to-r from-black to-gray-900 text-white py-2 px-4 rounded-full border border-yellow-400  justify-center shadow-md w-1/3 hidden md:flex ">
